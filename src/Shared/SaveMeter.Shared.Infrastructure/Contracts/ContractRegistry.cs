...
using SaveMeter.Shared.Abstractions.Contracts;
using SaveMeter.Shared.Abstractions.Messaging;
using SaveMeter.Shared.Infrastructure.Modules;

namespace SaveMeter.Shared.Infrastructure.Contracts;
    ...
    private void ValidateContract(Type contractType, string path = null)
    {
        ...
        var originalType = _types
            .Where(x => x.FullName is not null &&
                        x.FullName.Contains($"SaveMeter.Modules.{module}", StringComparison.InvariantCultureIgnoreCase))
